        ...
        <nav className="flex justify-between items-center p-4 border-b-1 border-slate-300 top-0 sticky bg-white relative">
            ...
            {isMenuOpen && (
                <div className="absolute top-full left-0 w-full bg-white flex flex-col gap-4 p-6 md:hidden border-b-1 border-slate-300">
                    <a href="#home" className="text-red-500">Inicio</a>
                    <a href="#services" className="text-red-500">Servicios</a>
                    <a href="#aboutus" className="text-red-500">Nosotros</a>
                    <a href="#contact" className="text-red-500">Contacto</a>
